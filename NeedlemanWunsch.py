...
################################################################################
# Program name      : NeedlemanWunsch.py
# Original Author   : Narendra Kumar, narekum@gmail.com
# Date created      : 03 May 2020
# Purpose           : Needleman and Wunsch Algorithm for global sequence alignment
...
from lib.align import N_W, PAIR_ALIGNED
...
def do_stuff(args):
    ...
    (aligned1,aligned2,indicators,identicals,similars,positives,gaps,score,seq1_chunk_spent,seq2_chunk_spent)=N_W(seq1,seq2,sm,gap)
    ali = PAIR_ALIGNED(aligned1,aligned2,indicators,header1,header2,identicals,similars,positives,gaps,gap,score,substitution_matrix,len(seq1),len(seq2),seq1_chunk_spent,seq2_chunk_spent,"Needleman and Wunsch")
    ali.print_alignment()
